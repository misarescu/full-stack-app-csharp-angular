...
namespace WorldCities.Data
{
    public class ApiResult<T>
    {
            ...
            int pageSize) 
        {
            ...
            // this may act funny i had to refactor it as the book code
            // throws awaiter not supported errors
        ...
        /*
         * <summary>
         * TRUE if the current page has previous page,
         * FALSTE otherwise
         * </summary>
         */
        ...
        /*
         * <summary>
         * TRUE if the current page has next page,
         * FALSE otherwise
         * </summary>
         */
